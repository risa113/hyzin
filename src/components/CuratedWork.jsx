...
export default function CuratedWork({ onSelectProject, onOpenLightbox }) {
  ...
  return (
    <section id="portfolio" className="py-24 sm:py-32 bg-[#2B1C19] text-[#FAF7F0] relative overflow-hidden border-t border-[#C9B29B]/20">
      ...
      <div className="absolute bottom-1/4 -right-48 w-96 h-96 bg-[#C9B29B]/10 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 pb-8 border-b border-[#C9B29B]/20 gap-6">
          <div>
            ...
            <p className="mt-3 text-sm sm:text-base text-[#C9B29B] font-normal max-w-2xl leading-relaxed animate-slide-down" style={{ animationDelay: '100ms' }}>
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <div className="bg-[#3E2723] border border-[#C9B29B]/20 p-1 rounded-lg flex items-center gap-1 shadow-lg">
              <button
                ...
                className={`px-4 py-2 rounded-md text-xs font-semibold uppercase tracking-wider flex items-center gap-2 transition-all ${
                  viewMode === 'grid'
                    ...
                    : 'text-[#C9B29B] hover:text-[#FAF7F0] hover:bg-white/5'
                }`}
              >
            ...
            <span className="text-xs text-[#D4AF37] font-semibold uppercase tracking-widest hidden sm:inline-block px-3 py-2 bg-[#3E2723] border border-[#C9B29B]/20 rounded-md">
        ...
        {viewMode === 'slideshow' && currentProject && (
          <div className="bg-[#3E2723] border border-[#C9B29B]/20 rounded-2xl overflow-hidden shadow-2xl relative mb-12 animate-page-enter">
            <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[550px]">
              ...
              <div className="lg:col-span-7 relative overflow-hidden bg-black group min-h-[380px] lg:min-h-[550px]">
                ...
                <div className="absolute top-5 left-5 right-5 flex items-center justify-between z-10">
                  ...
                  <span className="px-3.5 py-1.5 bg-[#2B1C19]/80 backdrop-blur-md border border-[#C9B29B]/20 text-[11px] font-mono uppercase tracking-widest text-[#FAF7F0] flex items-center gap-1.5 rounded">
                ...
                <button
                  ...
                  className="absolute top-5 right-5 z-20 p-3 rounded-full bg-[#2B1C19]/80 hover:bg-[#D4AF37] hover:text-[#2B1C19] text-[#FAF7F0] border border-[#C9B29B]/20 backdrop-blur-md transition-all shadow-xl hover:scale-110"
                ...
                <div className="absolute bottom-5 right-5 z-10">
                  <span className="font-mono text-xs text-[#D4AF37] bg-[#2B1C19]/90 px-4 py-2 border border-[#C9B29B]/20 rounded tracking-widest">
              ...
              <div className="lg:col-span-5 p-8 sm:p-12 flex flex-col justify-between bg-[#3E2723] border-t lg:border-t-0 lg:border-l border-[#C9B29B]/20">
                <div key={currentProject.id} className="space-y-6 animate-slide-right-pop">
                  ...
                  <p className="text-sm sm:text-base text-[#C9B29B] font-normal leading-relaxed animate-slide-down" style={{ animationDelay: '150ms' }}>
                    {currentProject.concept || currentProject.tagline}
                  </p>

                  {/* Highlights Bullet List */}
                  {currentProject.spaceHighlights && (
                    <div className="pt-4 border-t border-[#C9B29B]/20 space-y-2 animate-slide-down" style={{ animationDelay: '200ms' }}>
                      ...
                      {currentProject.spaceHighlights.slice(0, 3).map((hl, i) => (
                        <div key={i} className="text-xs text-[#C9B29B] flex items-start space-x-2">
                ...
                {/* Bottom Action Bar */}
                <div className="mt-8 pt-6 border-t border-[#C9B29B]/20 flex items-center justify-between gap-4">
                  <button
                    onClick={() => {
                      if (onOpenLightbox) {
            ...
            <div className="p-4 bg-[#2B1C19] border-t border-[#C9B29B]/20 flex items-center gap-3 overflow-x-auto no-scrollbar">
        ...
        {viewMode === 'grid' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 animate-page-enter">
            {filteredProjects.map((project, idx) => (
              <div
                key={project.id}
                className="group relative bg-[#3E2723] border border-[#C9B29B]/20 rounded-xl overflow-hidden shadow-xl transition-all duration-500 hover:border-[#D4AF37]/70 hover:-translate-y-1.5 flex flex-col justify-between reveal-up"
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10 pointer-events-none">
                    ...
                    <span className="px-2.5 py-1 bg-[#2B1C19]/80 backdrop-blur-md border border-[#C9B29B]/20 text-[10px] uppercase font-mono tracking-wider text-[#FAF7F0] flex items-center gap-1 rounded">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 z-20 p-2 rounded-full bg-[#2B1C19]/80 hover:bg-[#D4AF37] hover:text-[#2B1C19] text-[#FAF7F0] border border-[#C9B29B]/20 backdrop-blur-md transition-all shadow-lg hover:scale-110 opacity-90 group-hover:opacity-100"
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-[#C9B29B] font-normal line-clamp-2 leading-relaxed">
                      {project.concept || project.tagline}
                    </p>
                  </div>

                  {/* Card Bottom CTA */}
                  <div className="pt-4 border-t border-[#C9B29B]/20 flex items-center justify-between">
                    <button
                      onClick={() => {
                        if (onOpenLightbox) {
                    ...
                    <span className="text-[10px] text-[#C9B29B]/70 uppercase font-medium">
