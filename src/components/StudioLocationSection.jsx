...
export default function StudioLocationSection({ onOpenConsultation }) {
  ...
  return (
    <section id="location" className="py-20 sm:py-28 bg-[#2B1C19] border-t border-[#D4AF37]/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 rounded-2xl overflow-hidden border border-[#D4AF37]/20 bg-[#3E2723] shadow-2xl relative min-h-[380px] sm:min-h-[460px] flex flex-col">
            <div className="p-4 bg-[#2B1C19] border-b border-[#D4AF37]/20 flex items-center justify-between">
            ...
            <div className="flex-1 w-full h-full min-h-[320px] relative">
              ...
              {/* Float Card on Map */}
              <div className="absolute bottom-4 left-4 right-4 sm:right-auto sm:max-w-xs p-4 rounded-xl bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 shadow-xl text-left pointer-events-none">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6 bg-[#3E2723] border border-[#D4AF37]/20 p-6 sm:p-8 rounded-2xl shadow-xl">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#D4AF37] leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="p-3.5 bg-[#2B1C19] border border-[#D4AF37]/20 rounded-xl flex items-start space-x-3.5 hover:border-[#D4AF37]/40 transition-colors">
                ...
                <div className="p-3.5 bg-[#2B1C19] border border-[#D4AF37]/20 rounded-xl flex items-start space-x-3.5">
                  <div className="w-9 h-9 bg-[#3E2723] rounded-lg flex items-center justify-center flex-shrink-0 text-[#D4AF37]">
