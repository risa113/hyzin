...
export default function SeoFaqSection({ onOpenConsultation }) {
  ...
  return (
    <section className="py-24 bg-[#0e0f13] border-t border-white/[0.08] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#d4b584]/15 border border-[#d4b584]/30 text-[#d4b584] text-xs font-semibold uppercase tracking-wider mb-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#faf6ee] font-bold tracking-tight">
            FREQUENTLY ASKED <span className="text-[#d4b584] font-bold">QUESTIONS</span>
          </h2>
            ...
            return (
              <div
                ...
                className={`border rounded-xl transition-all duration-300 overflow-hidden ${
                  isOpen
                    ? 'bg-[#14151a] border-[#d4b584]/50 shadow-xl'
                    : 'bg-[#111216]/60 border-white/[0.08] hover:border-white/20'
                }`}
              >
                <button
                ...
                >
                  <span className="text-lg sm:text-xl text-white font-semibold tracking-tight">
                    {faq.q}
                  </span>
                  <div className={`p-2 rounded-full transition-transform duration-300 shrink-0 ${
                    isOpen ? 'bg-[#d4b584] text-[#0a0a0c] rotate-180' : 'bg-white/10 text-white'
                  }`}>
                ...
                {isOpen && (
                  <div className="px-6 pb-6 text-sm text-[#b5af9f] font-normal leading-relaxed border-t border-white/[0.06] pt-4 animate-fadeIn">
                    <p>{faq.a}</p>
                  </div>
                )}
              </div>
        ...
        <div className="mt-16 pt-12 border-t border-white/[0.08] grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="p-6 bg-[#14151a] border border-white/[0.06] rounded-xl">
            <ShieldCheck className="w-6 h-6 text-[#d4b584] mx-auto mb-3" />
            <h4 className="font-mono text-sm text-white font-bold uppercase tracking-wider">Turnkey Execution</h4>
            <p className="text-xs text-[#a8a195] mt-1 font-light">From raw site framing to white-glove handover in 35 days.</p>
          </div>

          <div className="p-6 bg-[#14151a] border border-white/[0.06] rounded-xl">
            <Sparkles className="w-6 h-6 text-[#d4b584] mx-auto mb-3" />
            <h4 className="font-mono text-sm text-white font-bold uppercase tracking-wider">10-Year Craft Warranty</h4>
            <p className="text-xs text-[#a8a195] mt-1 font-light">Guaranteed hardware, moisture protection, and structural integrity.</p>
          </div>

          <div className="p-6 bg-[#14151a] border border-white/[0.06] rounded-xl flex flex-col justify-between">
            <div>
              <h4 className="font-mono text-sm text-white font-bold uppercase tracking-wider">Ready to Start?</h4>
              <p className="text-xs text-[#a8a195] mt-1 font-light">Book your 3D consultation & BOQ cost estimate today.</p>
            </div>
            <button
              onClick={onOpenConsultation}
              className="mt-4 py-2.5 px-4 bg-[#d4b584] hover:bg-[#faf0dc] text-[#0a0a0c] text-xs font-mono font-bold uppercase tracking-wider rounded-lg transition-colors flex items-center justify-center space-x-2"
            >
