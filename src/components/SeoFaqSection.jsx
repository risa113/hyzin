  ...
  return (
    <section className="py-24 bg-[#2B1C19] border-t border-[#C9B29B]/20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div
                ...
                className={`border rounded-xl transition-all duration-300 overflow-hidden ${
                  isOpen
                    ...
                    : 'bg-[#3E2723]/60 border-[#C9B29B]/20 hover:border-[#D4AF37]/30'
                }`}
              >
                <button
                ...
                {isOpen && (
                  <div className="px-6 pb-6 text-sm text-[#C9B29B] font-normal leading-relaxed border-t border-[#C9B29B]/20 pt-4 animate-fadeIn">
                    <p>{faq.a}</p>
                  </div>
                )}
              </div>
        ...
        <div className="mt-16 pt-12 border-t border-[#C9B29B]/20 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="p-6 bg-[#3E2723] border border-[#C9B29B]/20 rounded-xl">
            ...
            <p className="text-xs text-[#C9B29B] mt-1 font-normal">From raw site framing to white-glove handover in 35 days.</p>
          </div>
          ...
          <div className="p-6 bg-[#3E2723] border border-[#C9B29B]/20 rounded-xl">
            ...
            <p className="text-xs text-[#C9B29B] mt-1 font-normal">Guaranteed hardware, moisture protection, and structural integrity.</p>
          </div>

          <div className="p-6 bg-[#3E2723] border border-[#C9B29B]/20 rounded-xl flex flex-col justify-between">
            <div>
              <h4 className="font-mono text-sm text-[#FAF7F0] font-bold uppercase tracking-wider">Ready to Start?</h4>
              <p className="text-xs text-[#C9B29B] mt-1 font-normal">Book your 3D consultation & BOQ cost estimate today.</p>
            </div>
            <button
