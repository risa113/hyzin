...
export default function ConsultationForm({ prefilledProject = '', selectedRegion = '' }) {
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 bg-[#2B1C19] border-t border-[#D4AF37]/20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 text-base text-[#D4AF37] font-normal leading-relaxed">
            ...
            <div className="mt-10 space-y-5 pt-6 border-t border-[#D4AF37]/20">
              
              {/* Studio Email */}
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-[#3E2723] border border-[#D4AF37]/20 flex items-center justify-center flex-shrink-0 text-[#D4AF37]">
                  <Mail className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] uppercase font-semibold tracking-wider text-[#D4AF37]/70 block">
              ...
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-[#3E2723] border border-[#D4AF37]/20 flex items-center justify-center flex-shrink-0 text-[#25D366]">
            ...
            <div className="mt-8 p-4 bg-[#3E2723] border border-[#D4AF37]/20 text-[11px] text-[#D4AF37] leading-relaxed">
          ...
          <div className="lg:col-span-7 bg-[#3E2723] border border-[#D4AF37]/20 p-8 sm:p-12 shadow-2xl relative">
            ...
            {isSubmitted ? (
              <div className="text-center py-10 animate-fadeIn">
                ...
                <p className="text-sm text-[#D4AF37] font-normal max-w-md mx-auto leading-relaxed mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md mx-auto mb-8 text-left">
                  ...
                  <div className="p-3.5 bg-[#2B1C19] border border-[#D4AF37]/40 rounded-lg">
                    ...
                    <p className="text-[11px] text-[#D4AF37] break-all">
                ...
                <div className="p-6 bg-[#2B1C19] border border-[#D4AF37]/30 max-w-md mx-auto text-left mb-8 space-y-3 shadow-xl">
                  ...
                  <a
                    ...
                    className="w-full py-2.5 bg-transparent border border-[#D4AF37]/20 hover:border-[#D4AF37] text-[#FAF7F0] text-xs font-medium uppercase tracking-wider flex items-center justify-center space-x-2 transition-colors rounded-sm"
                  >
                ...
                <button
                  ...
                  className="text-xs text-[#D4AF37] hover:text-[#D4AF37] uppercase tracking-widest font-semibold"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="border-b border-[#D4AF37]/20 pb-4 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {/* Name */}
                  <div>
                    <label className="block text-[11px] uppercase font-mono tracking-wider text-[#D4AF37] mb-2">
                      Your Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 bg-[#2B1C19] border border-[#D4AF37]/20 focus:border-[#D4AF37] text-[#FAF7F0] placeholder-[#D4AF37]/50 text-sm focus:outline-none transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-[#2B1C19] border border-[#D4AF37]/20 focus:border-[#D4AF37] text-[#FAF7F0] text-sm focus:outline-none transition-colors"
                  >
                    {regions.map((reg) => (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-[#2B1C19] border border-[#D4AF37]/20 focus:border-[#D4AF37] text-[#FAF7F0] placeholder-[#D4AF37]/50 text-sm focus:outline-none transition-colors resize-none"
                  ></textarea>
                </div>
                ...
                <div className="pt-4 flex flex-col gap-3">
                  ...
                  <p className="text-[10px] text-center text-[#D4AF37]">
