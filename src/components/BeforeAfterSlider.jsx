...
export default function BeforeAfterSlider({ onOpenLightbox }) {
  ...
  return (
    <section className="py-24 sm:py-32 bg-[#4E342E] border-t border-[#D4AF37]/20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Heading */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-[#D4AF37]/20 pb-6">
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-[#D4AF37] font-normal leading-relaxed max-w-xl">
        ...
        <div
          ...
          className="relative w-full h-[460px] sm:h-[600px] lg:h-[660px] border border-[#D4AF37]/20 shadow-2xl overflow-hidden cursor-ew-resize select-none bg-[#2B1C19] rounded-sm animate-slide-right-pop"
        >
          ...
          >
            ...
            />
            {/* Before Tag */}
            <div className="absolute top-6 left-6 z-10 px-4 py-1.5 bg-[#2B1C19]/90 text-[#FAF7F0] text-[10px] sm:text-xs font-semibold uppercase tracking-widest border border-[#D4AF37]/30 shadow-lg">
          ...
          <div className="absolute bottom-6 left-6 right-6 p-4 sm:p-5 bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 text-[#FAF7F0] z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 pointer-events-none rounded-sm">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#D4AF37] font-normal mt-0.5">
