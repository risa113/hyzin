  ...
  return (
    <section className="py-24 sm:py-32 bg-[#4E342E] border-t border-[#C9B29B]/20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Heading */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-[#C9B29B]/20 pb-6">
          <div>
            <div className="inline-flex items-center space-x-2 text-[11px] uppercase tracking-[0.25em] text-[#D4AF37] font-medium mb-2">
            ...
            <p className="mt-2 text-sm sm:text-base text-[#C9B29B] font-normal leading-relaxed max-w-xl">
              Authentic on-site transformations. Compare raw site execution with our finalized, precision-crafted handovers.
            </p>
          </div>

          <div className="mt-4 md:mt-0 font-medium text-xs text-[#C9B29B]">
        ...
        <div
          ...
          className="relative w-full h-[460px] sm:h-[600px] lg:h-[660px] border border-[#C9B29B]/20 shadow-2xl overflow-hidden cursor-ew-resize select-none bg-[#2B1C19] rounded-sm animate-slide-right-pop"
        >
          ...
          <div className="absolute inset-0 w-full h-full">
            ...
            />
            {/* After Tag */}
            <div className="absolute top-6 right-6 z-10 px-4 py-1.5 bg-[#D4AF37] text-[#2B1C19] text-[10px] sm:text-xs font-bold uppercase tracking-widest shadow-lg">
          ...
          >
            ...
            />
            {/* Before Tag */}
            <div className="absolute top-6 left-6 z-10 px-4 py-1.5 bg-[#2B1C19]/90 text-[#FAF7F0] text-[10px] sm:text-xs font-semibold uppercase tracking-widest border border-[#C9B29B]/30 shadow-lg">
          ...
          >
            <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#2B1C19] border-2 border-[#D4AF37] text-white flex items-center justify-center shadow-2xl">
              <SplitSquareHorizontal className="w-5 h-5 text-[#D4AF37]" />
            </div>
          </div>

          {/* Bottom Information Overlay */}
          <div className="absolute bottom-6 left-6 right-6 p-4 sm:p-5 bg-[#2B1C19]/90 backdrop-blur-md border border-[#C9B29B]/20 text-[#FAF7F0] z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 pointer-events-none rounded-sm">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#C9B29B] font-normal mt-0.5">
            ...
            {onOpenLightbox && (
              <button
                ...
                className="text-[11px] font-semibold text-[#D4AF37] hover:text-[#FAF7F0] uppercase tracking-wider flex-shrink-0 pointer-events-auto underline"
              >
