...
export default function BrandIntro({ onExploreServices, onOpenLightbox }) {
  ...
  return (
    <section id="about" className="relative py-24 sm:py-32 bg-[#2B1C19] border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FAF7F0] tracking-tight leading-[1.15]">
              WE DESIGN SPACES WITH{' '}
              <span className="text-[#D4AF37] font-bold">CHARACTER.</span>
            </h2>

            <p className="mt-8 text-base sm:text-lg text-[#D4AF37] font-normal leading-relaxed">
            ...
            <div className="mt-10 p-6 sm:p-8 bg-[#2B1C19] border-l-2 border-[#D4AF37] relative">
            ...
            <div className="mt-8">
              <button
                ...
                className="group inline-flex items-center space-x-3 text-xs uppercase tracking-[0.25em] text-[#D4AF37] hover:text-[#FAF7F0] font-semibold transition-colors"
              >
          ...
          <div className="lg:col-span-6 relative">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 sm:p-5 bg-[#2B1C19]/90 backdrop-blur-md border border-white/10 flex items-center justify-between">
                <div>
                  <span className="text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] block font-medium">
                    ORIGINAL CLIENT WORK
                  </span>
                  <span className="text-base sm:text-lg font-semibold text-[#FAF7F0]">
                    Living Paneling & Ambient Cove
                  </span>
                </div>
                <div className="text-right font-medium text-[10px] text-[#D4AF37]">
                  <div>STUDIO DESK</div>
                  <div className="text-[#D4AF37]">+91 6282549008</div>
                </div>
              </div>
            </div>

            {/* Subtle decorative offset border */}
            <div className="hidden sm:block absolute -bottom-4 -right-4 w-full h-full border border-[#D4AF37]/20 pointer-events-none -z-10"></div>
          </div>
