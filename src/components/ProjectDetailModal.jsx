...
export default function ProjectDetailModal({ project, onClose, onCommissionProject }) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/90 backdrop-blur-2xl flex justify-center items-start sm:p-4 md:p-6 lg:p-8 animate-fadeIn">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-5xl bg-[#2B1C19] border border-[#D4AF37]/20 shadow-2xl my-auto overflow-hidden">
        
        {/* Sticky Close & Bar */}
        <div className="sticky top-0 z-30 bg-[#2B1C19]/95 backdrop-blur-md border-b border-[#D4AF37]/20 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={onClose}
              className="p-2 text-[#D4AF37] hover:text-[#FAF7F0] bg-white/5 hover:bg-white/10 transition-colors"
        ...
        <div className="relative w-full h-[400px] sm:h-[520px] bg-black overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6 sm:bottom-10 sm:left-10 sm:right-10">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              <span className="px-3 py-1 bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 text-[10px] uppercase font-mono tracking-widest text-[#D4AF37] font-semibold">
                {project.type}
              </span>
              <span className="px-3 py-1 bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 text-[10px] uppercase font-mono tracking-widest text-[#FAF7F0]">
                {project.location}
              </span>
              <span className="px-3 py-1 bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 text-[10px] uppercase tracking-wider text-[#D4AF37] font-medium">
        ...
        <div className="px-6 sm:px-10 py-4 bg-[#3E2723] border-b border-[#D4AF37]/20 flex items-center space-x-3 overflow-x-auto">
        ...
        <div className="p-6 sm:p-10 space-y-12">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-[#D4AF37] font-normal leading-relaxed">
              {project.concept}
            </p>
          </div>

          {/* Section 2: Spatial Highlights */}
          <div className="bg-[#3E2723] p-6 sm:p-8 border border-[#D4AF37]/20 shadow-xl">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {project.materials.map((mat, i) => (
                <div
                  key={i}
                  className="p-4 bg-[#3E2723] border border-[#D4AF37]/20 flex flex-col justify-between hover:border-[#D4AF37]/50 transition-colors shadow-md"
                >
                  <span className="text-base sm:text-lg text-[#FAF7F0] font-bold tracking-tight">
                    {mat.name}
                  </span>
                  <span className="text-xs text-[#D4AF37] mt-1 font-normal">
                    {mat.role}
                  </span>
                </div>
              ))}
          ...
          {project.clientReview && (
            <div className="p-6 sm:p-8 bg-[#3E2723] border-l-2 border-[#D4AF37] relative shadow-lg">
              ...
              <span className="block mt-4 text-xs font-semibold uppercase tracking-wider text-[#D4AF37]">
          ...
          <div className="pt-8 border-t border-[#D4AF37]/20 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h5 className="text-xl sm:text-2xl text-[#FAF7F0] font-bold tracking-tight">
                HAVE A SPACE IN MIND?
              </h5>
              <p className="text-sm text-[#D4AF37] mt-1 font-normal">
