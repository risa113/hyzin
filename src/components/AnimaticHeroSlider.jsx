    ...
    >
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-4 sm:pt-28 lg:pt-36 pb-4 sm:pb-8 flex-1 flex flex-col justify-center">
        <div key={currentSlide} className="max-w-3xl animate-slide-right-pop">
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1 sm:px-3.5 sm:py-1.5 bg-[#2B1C19]/80 backdrop-blur-md border border-[#D4AF37]/50 shadow-sm mb-3 sm:mb-6 animate-slide-right-pop">
          ...
          {/* Editorial Headline */}
          <h1 className="text-2xl sm:text-5xl lg:text-7xl font-extrabold text-[#FAF7F0] leading-[1.15] sm:leading-[1.1] tracking-tight drop-shadow-md transition-all duration-500 animate-slide-right-pop delay-100">
            {active.title}{' '}
          ...
          <p className="mt-2.5 sm:mt-6 text-xs sm:text-base lg:text-lg text-[#C9B29B] font-normal leading-relaxed max-w-2xl transition-all duration-500 line-clamp-3 sm:line-clamp-none animate-slide-right-pop delay-150">
            {active.tagline}
          </p>

          <p className="mt-1.5 sm:mt-3 text-[10px] sm:text-sm uppercase tracking-[0.18em] sm:tracking-[0.2em] text-[#D4AF37] font-medium animate-slide-right-pop delay-200">
            {active.badge}
          </p>
          ...
          <div className="mt-4 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-5 animate-pop-up delay-300">
            ...
            <button
              ...
              className="px-6 py-2.5 sm:px-8 sm:py-4 bg-[#3E2723]/80 hover:bg-[#4E342E] border border-[#C9B29B]/30 text-[#FAF7F0] text-[11px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] font-medium transition-all duration-300 backdrop-blur-md shadow-sm flex items-center justify-center space-x-2.5 rounded-sm"
            >
            ...
            {onOpenLightbox && (
              <button
                ...
                className="hidden sm:inline-flex p-4 bg-[#2B1C19]/60 hover:bg-[#D4AF37] hover:text-[#2B1C19] text-[#FAF7F0] border border-[#C9B29B]/20 transition-colors backdrop-blur-md"
      ...
      <div className="relative z-20 w-full max-w-full overflow-hidden border-t border-[#C9B29B]/20 bg-[#2B1C19]/95 backdrop-blur-md mt-4 sm:mt-12">
            ...
            {slides.map((s, idx) => (
              <button
                ...
                className={`relative flex items-center gap-1.5 sm:gap-2 p-1 sm:p-1.5 rounded-lg sm:rounded-xl border transition-all flex-shrink-0 ${
                  idx === currentSlide 
                    ? 'bg-[#4E342E] border-[#D4AF37] shadow-md scale-105' 
                    : 'bg-[#2B1C19]/60 border-[#C9B29B]/20 opacity-70 hover:opacity-100 hover:border-[#D4AF37]/50'
                }`}
              >
                ...
                <span className="text-[9px] sm:text-[10px] font-medium text-[#FAF7F0] whitespace-nowrap hidden sm:inline pr-1">
                  0{idx + 1}. {s.service}
                </span>
              </button>
            ))}
        ...
        <div className="border-t border-[#C9B29B]/15 py-3 sm:py-5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 items-center text-white">
              {statsData.map((stat, idx) => (
                <div
                  key={idx}
                  className="flex flex-col border-l border-[#C9B29B]/20 pl-3 sm:pl-6 first:border-l-0"
                >
                  ...
                  <span className="text-[9px] text-[#C9B29B] tracking-wider hidden sm:block">
                    {stat.detail}
                  </span>
                </div>
              ))}
