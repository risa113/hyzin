    ...
    <section className="py-20 bg-[#4E342E] relative overflow-hidden" id="photo-vault">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="relative w-full md:w-80">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#D4AF37] hover:text-[#FAF7F0]"
                >
                  ✕
                </button>
              )}
        ...
        {displayedPhotos.length > 0 ? (
          <div key={`${selectedCategory}-${searchQuery}`} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 animate-slide-right-pop">
            {displayedPhotos.map((photo, idx) => (
              <div
                ...
                className="group relative bg-[#3E2723] rounded-3xl overflow-hidden border border-[#D4AF37]/20 shadow-md hover:border-[#D4AF37]/50 hover:shadow-2xl transition-all duration-300 cursor-pointer flex flex-col justify-between reveal-up"
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-[#2B1C19]">
                  ...
                  {/* Location Tag */}
                  <div className="absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 text-[#FAF7F0] text-[10px] font-bold shadow">
                ...
                <div className="p-4 bg-[#3E2723]">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {photo.tags.slice(0, 3).map((tag, tIdx) => (
                      <span key={tIdx} className="px-2 py-0.5 rounded-md bg-[#2B1C19] border border-[#D4AF37]/20 text-[10px] text-[#D4AF37] font-medium">
                        #{tag}
                      </span>
                    ))}
                  </div>
          ...
          <div className="text-center py-16 bg-[#3E2723] rounded-3xl border border-[#D4AF37]/20">
            ...
            <p className="text-xs text-[#D4AF37] mt-1">Try clearing your search query or selecting another category tab.</p>
            <button
              onClick={() => {
