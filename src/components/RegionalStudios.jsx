...
export default function RegionalStudios({ onSelectRegion, onOpenLightbox }) {
  ...
  return (
    <section id="studios" className="py-24 sm:py-32 bg-[#2B1C19] border-t border-[#D4AF37]/20 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div 
              ...
              className="relative overflow-hidden border border-[#D4AF37]/20 shadow-2xl group cursor-pointer bg-[#3E2723]"
            >
              <img
              ...
              {/* Studio Stamp Badge */}
              <div className="absolute bottom-6 left-6 right-6 p-5 bg-[#2B1C19]/90 backdrop-blur-md border border-[#D4AF37]/20 shadow-xl">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="mt-4 text-base text-[#D4AF37] font-normal leading-relaxed">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-[10px] font-medium text-[#D4AF37]/70 hidden sm:block">
                          {studio.coordinates}
                        </span>
                        <ArrowUpRight
                          className={`w-4 h-4 transition-transform duration-300 ${
                            isActive ? 'rotate-45 text-[#D4AF37]' : 'text-[#D4AF37]'
                          }`}
                        />
                      </div>
                    </div>
                    ...
                    {isActive && (
                      <div className="mt-4 pt-4 border-t border-[#D4AF37]/20 animate-fadeIn text-sm">
                        <p className="text-[#FAF7F0] font-normal leading-relaxed mb-4">
                          {studio.description}
                        </p>
                        <div className="text-xs text-[#D4AF37] font-medium mb-4">
