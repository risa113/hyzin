      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-[#D4AF37]/20 pb-3 mb-3">
            ...
            <button
              onClick={() => setIsOpen(false)}
              className="w-7 h-7 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center text-[#D4AF37] hover:text-[#FAF7F0] transition-colors"
          ...
          <div className="space-y-2.5">
            {/* 1. WhatsApp Channel */}
            <div className="p-3 bg-[#3E2723] hover:bg-[#25D366]/15 border border-[#D4AF37]/20 hover:border-[#25D366]/70 rounded-xl transition-all group">
              <a
                href={whatsapp1}
                target="_blank"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-[11px] text-[#D4AF37] block truncate font-mono mt-0.5">
                    +91 6282549008
                  </span>
                  <span className="text-[9px] text-[#D4AF37]/70 block truncate">
              ...
              <div className="mt-2 pt-2 border-t border-white/5 flex items-center justify-between text-[10px]">
                <span className="text-[#D4AF37] font-mono">Line 2: +91 8848023041</span>
                <a
                  href={whatsapp2}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={handleChannelClick}
              className="p-3 bg-[#3E2723] hover:bg-[#E1306C]/15 border border-[#D4AF37]/20 hover:border-[#E1306C]/70 rounded-xl flex items-center space-x-3 transition-all group"
            >
            ...
            <a
              href={emailUrl}
              onClick={handleChannelClick}
              className="p-3 bg-[#3E2723] hover:bg-[#D4AF37]/15 border border-[#D4AF37]/20 hover:border-[#D4AF37]/70 rounded-xl flex items-center space-x-3 transition-all group"
            >
