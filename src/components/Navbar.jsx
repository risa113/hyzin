...
export default function Navbar({ activePage, onNavigate, onOpenConsultation, onSelectService }) {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#341910] border-b border-[#CFB291]/15 hidden md:flex items-center justify-between py-2 px-6 lg:px-10 z-50 relative">
        ...
        <div className="flex items-center gap-5 whitespace-nowrap">
          <a
            ...
            className="flex items-center gap-1.5 text-[10px] tracking-[0.18em] uppercase text-[#FCFCF6] hover:text-[#CFB291] transition-colors duration-200 group"
          >
            <Phone className="w-2.5 h-2.5 text-[#CFB291] group-hover:scale-110 transition-transform" />
          ...
          <a
            ...
            className="flex items-center gap-1 text-[10px] tracking-[0.18em] uppercase text-[#FCFCF6] hover:text-[#E1306C] transition-colors duration-200 group"
          >
            <span>@hyzin.interior</span>
            <ArrowUpRight className="w-2.5 h-2.5 text-[#CFB291] group-hover:text-[#E1306C] transition-colors" />
          </a>
        </div>
      </div>
      ...
      {/* ─── MAIN HEADER ────────────────────────────────────────────────────── */}
      <header
        className={`sticky top-0 z-40 w-full max-w-full overflow-visible transition-all duration-500 border-b border-[#CFB291]/20 ${
          isScrolled
            ? 'bg-[#341910]/98 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.6)] py-4'
            : 'bg-transparent py-4'
        }`}
      >
        <div className="max-w-[1400px] w-full mx-auto px-5 sm:px-8 lg:px-10 flex items-center justify-between gap-6">
          ...
          >
            ...
            <div className="relative">
              <img
                ...
                className="w-11 h-11 object-contain border border-[#CFB291]/35 group-hover:border-[#CFB291]/70 shadow-[0_0_20px_rgba(201,168,76,0.08)] group-hover:shadow-[0_0_28px_rgba(201,168,76,0.2)] group-hover:scale-105 transition-all duration-400"
              />
            </div>
            ...
            <div className="flex flex-col leading-none gap-1">
              <div className="flex items-baseline gap-2">
                <span className="text-xl sm:text-2xl font-bold tracking-[0.2em] text-[#FCFCF6] group-hover:text-[#FCFCF6] transition-colors duration-300 uppercase">
                  HYZIN
                </span>
                <span className="text-base sm:text-lg font-semibold tracking-[0.18em] text-[#CFB291] uppercase">
                  INTERIOR
                </span>
              </div>
              <span className="text-[9px] tracking-[0.32em] uppercase text-[#CFB291]/70 font-medium">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        {CLIENT_SERVICES_CONFIG.map((srv) => (
                          <button
                            ...
                            className="p-2.5 text-left bg-[#45241A] hover:bg-[#5A3122] border border-transparent hover:border-[#CFB291]/35 text-[#FCFCF6] hover:text-[#CFB291] transition-all duration-200 flex items-center gap-2.5 group/item cursor-pointer"
                          >
                            <span className="flex-shrink-0 text-[10px] font-bold text-[#CFB291] bg-[#341910] px-1.5 py-0.5 border border-[#CFB291]/25 font-mono">
                              {srv.number}
                            </span>
                            <span className="text-[11px] font-semibold tracking-[0.04em] truncate group-hover/item:text-[#CFB291] transition-colors">
                              {srv.title}
                            </span>
                          </button>
                        ))}
                      ...
                      <div className="mt-4 pt-3 border-t border-[#CFB291]/20 flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-4 py-1.5 bg-[#CFB291] hover:bg-[#FCFCF6] text-[#341910] font-bold text-[10px] uppercase tracking-[0.2em] transition-colors duration-200 shadow-[0_4px_16px_rgba(201,168,76,0.25)] cursor-pointer"
                        >
                          View Full Specs →
                        </button>
                      </div>
          ...
          <div className="hidden sm:flex items-center shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-[#CFB291] hover:bg-[#FCFCF6] text-[#341910] font-bold text-[10px] uppercase tracking-[0.25em] transition-all duration-300 shadow-[0_4px_24px_rgba(201,168,76,0.2)] hover:shadow-[0_4px_32px_rgba(201,168,76,0.35)] group whitespace-nowrap cursor-pointer"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 text-[#FCFCF6] hover:text-[#CFB291] focus:outline-none cursor-pointer transition-colors duration-200"
        ...
        <div
          className={`lg:hidden fixed inset-x-0 top-full bg-[#341910]/98 backdrop-blur-2xl border-b border-[#CFB291]/20 transition-all duration-300 overflow-y-auto shadow-[0_20px_60px_rgba(0,0,0,0.9)] ${
        ...
        >
          <div className="px-5 space-y-3">
                    ...
                    <button
                      ...
                      className={`py-2.5 px-3 text-left flex items-center justify-between transition-all border ${
                        isActive || mobileServicesOpen
                          ? 'bg-[#45241A] text-[#CFB291] border-[#CFB291]/60 font-bold'
                          : 'bg-[#45241A] text-[#FCFCF6] border-[#CFB291]/15 hover:border-[#CFB291]/50'
                      }`}
                    >
                      <span className="truncate">{link.name}</span>
                      <ChevronDown
                        className={`w-3 h-3 text-[#CFB291] flex-shrink-0 transition-transform duration-300 ${
            ...
            {mobileServicesOpen && (
              <div className="bg-[#341910] border border-[#CFB291]/30 p-4 space-y-2">
                <div className="flex items-center justify-between pb-2.5 border-b border-[#CFB291]/20">
                  <span className="text-[10px] font-bold text-[#CFB291] uppercase tracking-[0.24em] flex items-center gap-1.5">
                    <span className="inline-block w-1.5 h-1.5 rounded-full bg-[#CFB291] animate-pulse" />
                    All 10 Client Services
                  </span>
                  <button
                    onClick={() => handleNavClick('services')}
                    className="text-[10px] text-[#FCFCF6] hover:text-[#CFB291] font-bold uppercase tracking-wider transition-colors"
                  >
                    Open Page →
                  </button>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 max-h-56 overflow-y-auto pr-1">
                  {CLIENT_SERVICES_CONFIG.map((srv) => (
                    <button
                      key={srv.id}
                      onClick={() => handleServiceClick(srv.id)}
                      className="p-2 text-left bg-[#45241A] border border-[#CFB291]/15 hover:border-[#CFB291]/50 flex items-center gap-2 text-[11px] text-[#FCFCF6] hover:text-[#CFB291] transition-colors cursor-pointer"
                    >
                      <span className="flex-shrink-0 text-[10px] text-[#CFB291] font-bold bg-[#341910] px-1.5 py-0.5 border border-[#CFB291]/25 font-mono">
                        {srv.number}
                      </span>
            ...
            <div className="pt-2 border-t border-[#CFB291]/15 space-y-2">
              {/* Full-width gold CTA */}
              <button
                onClick={() => {
                  setMobileMenuOpen(false);
                ...
                className="w-full py-3.5 bg-[#CFB291] hover:bg-[#FCFCF6] text-[#341910] font-bold text-center tracking-[0.25em] text-[11px] uppercase transition-colors duration-200 flex items-center justify-center gap-2 shadow-[0_4px_20px_rgba(201,168,76,0.3)] cursor-pointer"
              >
                <span>START YOUR PROJECT</span>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-[10px] font-medium">
                <a
                  href="tel:916282549008"
                  className="py-2 px-2 bg-[#45241A] border border-[#CFB291]/15 flex items-center justify-center gap-1.5 text-[#FCFCF6] hover:text-[#CFB291] hover:border-[#CFB291]/40 transition-all"
                >
