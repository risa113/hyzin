      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonialsData.map((item, idx) => (
            <div
              key={item.id}
              className="p-8 bg-[#3E2723] border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-300 flex flex-col justify-between reveal-up rounded-sm shadow-lg"
            ...
            >
              ...
              <div className="pt-4 border-t border-[#D4AF37]/20">
                ...
                <span className="text-xs text-[#D4AF37] block font-medium mt-0.5">
                  {item.location}
                </span>
        ...
        <div className="mt-12 text-center text-xs text-[#D4AF37]/60 font-medium uppercase tracking-widest">
