...
export default function AboutPage({ onOpenConsultation, onSelectRegion, onOpenLightbox }) {
  return (
    <div className="animate-page-enter pt-12 pb-24 bg-[#5A3122]">
      {/* Page Header */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 border-b border-[#CFB291]/20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-6xl text-[#FCFCF6] font-extrabold leading-[1.12] tracking-tight">
            Designing with <span className="text-[#CFB291]">Purpose</span> & Quiet Permanence.
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#341910]/90 via-transparent to-transparent"></div>
              <div className="absolute bottom-6 left-6 right-6 p-6 bg-[#341910]/95 backdrop-blur-md border border-[#CFB291]/20">
                <span className="text-lg sm:text-xl font-medium text-[#FCFCF6] block leading-snug">
                  “Good interiors don’t simply look beautiful. They make everyday life better.”
                </span>
                <span className="text-[10px] uppercase font-semibold tracking-wider text-[#CFB291] mt-2 block">
          ...
          <div className="lg:col-span-6 space-y-6 text-[#CFB291] font-normal text-base leading-relaxed">
            ...
            <div className="pt-6 grid grid-cols-3 gap-4 border-t border-[#CFB291]/20 text-xs">
              <div className="p-4 bg-[#45241A] border border-[#CFB291]/20">
                <span className="text-2xl sm:text-3xl text-[#FCFCF6] block font-bold tracking-tight">10</span>
                <span className="text-[#CFB291] uppercase text-[10px] font-semibold mt-1 block">Core Disciplines</span>
              </div>
              <div className="p-4 bg-[#45241A] border border-[#CFB291]/20">
                <span className="text-2xl sm:text-3xl text-[#FCFCF6] block font-bold tracking-tight">50+</span>
                <span className="text-[#CFB291] uppercase text-[10px] font-semibold mt-1 block">Delivered Works</span>
              </div>
              <div className="p-4 bg-[#45241A] border border-[#CFB291]/20">
                <span className="text-2xl sm:text-3xl text-[#FCFCF6] block font-bold tracking-tight">3 States</span>
                <span className="text-[#CFB291] uppercase text-[10px] font-semibold mt-1 block">Kerala • TN • KA</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        <div className="p-10 sm:p-14 bg-[#45241A] border border-[#CFB291]/20 shadow-2xl">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl text-[#FCFCF6] font-bold tracking-tight">
            Initiate a Private Spatial Dialogue
          </h3>
          <p className="mt-2 text-sm text-[#CFB291] max-w-lg mx-auto font-normal">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="px-8 py-4 bg-[#CFB291] hover:bg-[#FCFCF6] text-[#341910] text-xs uppercase tracking-[0.25em] font-semibold transition-colors shadow-lg"
            >
              START YOUR PROJECT
            </button>
            <a
              href="tel:6282549008"
              className="px-8 py-4 border border-[#CFB291]/50 hover:border-[#CFB291] text-[#FCFCF6] hover:text-[#CFB291] text-xs uppercase tracking-[0.2em] font-semibold transition-colors flex items-center space-x-2"
            >
