...
export default function HomePage({ onNavigate, onSelectProject, onOpenConsultation, onOpenLightbox }) {
  ...
  return (
    <div className="animate-page-enter">
      ...
      ═══════════════════════════════════════════ */}
      <div className="w-full bg-[#2B1C19] border-y border-[#D4AF37]/25 overflow-hidden py-4 select-none">
        <div className="hyzin-marquee-track">
          {/* Duplicate text block so the animation loops seamlessly */}
          {[0, 1].map((i) => (
            <span
              key={i}
              className="text-[#D4AF37] text-[11px] sm:text-[13px] uppercase tracking-[0.35em] font-semibold pr-0"
              aria-hidden={i === 1}
            >
      ...
      ═══════════════════════════════════════════ */}
      <section className="py-28 sm:py-36 bg-[#4E342E] relative overflow-hidden border-b border-[#D4AF37]/15">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-7 relative">
              ...
              <div
                ...
                style={{ color: '#D4AF37', opacity: 0.06 }}
                aria-hidden="true"
              >
                01
              </div>
              ...
              {/* Main Headline */}
              <h2 className="relative z-10 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-[#FAF7F0] leading-[1.05] tracking-tight mb-6">
                WE DESIGN SPACES<br />
                <span className="text-[#D4AF37]">WITH CHARACTER.</span>
              </h2>

              {/* Sub-paragraph */}
              <p className="relative z-10 text-sm sm:text-base text-[#C9B29B] leading-relaxed max-w-xl mb-10">
              ...
              <div className="relative z-10 border-l-2 border-[#D4AF37] pl-6 py-2 mb-10 bg-[#3E2723] pr-6">
                <span className="text-[10px] uppercase tracking-[0.3em] text-[#D4AF37] font-semibold block mb-2">
                  OUR PHILOSOPHY
                </span>
                <blockquote className="text-lg sm:text-xl text-[#FAF7F0] font-medium leading-relaxed italic">
              ...
              <button
                ...
                className="relative z-10 inline-flex items-center gap-3 px-8 py-4 bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-[10px] uppercase tracking-[0.3em] font-black transition-colors duration-300"
              >
            ...
            <div className="lg:col-span-5">
              <div
                ...
                className="relative overflow-hidden border border-[#D4AF37]/25 shadow-2xl bg-[#3E2723] cursor-pointer group"
              >
                {/* Gold top accent line */}
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-[#D4AF37] z-10" />
                ...
                {/* Gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#2B1C19]/85 via-[#2B1C19]/10 to-transparent" />

                {/* Overlay caption */}
                <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-[#D4AF37]/20 bg-[#2B1C19]/80 backdrop-blur-sm">
                  <span className="text-[9px] uppercase tracking-[0.35em] text-[#D4AF37] font-semibold block mb-1">
                    ORIGINAL CLIENT WORK
                  </span>
                  <span className="text-base font-bold text-[#FAF7F0] block tracking-wide">
      ...
      ═══════════════════════════════════════════ */}
      <section className="w-full bg-[#2B1C19] border-b border-[#D4AF37]/20 relative overflow-hidden">
        {/* Decorative vertical gold lines */}
        <div className="absolute left-[38%] top-0 bottom-0 w-[1px] bg-[#D4AF37]/8 hidden lg:block pointer-events-none" />
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-16">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-5">
                <Box className="w-4 h-4 text-[#D4AF37]" strokeWidth={1.5} />
                <span className="text-[10px] uppercase tracking-[0.4em] text-[#D4AF37] font-semibold">
                  3D INTERACTIVE HOUSE MODEL
                </span>
              </div>

              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#FAF7F0] leading-[1.05] tracking-tight mb-5">
                EXPERIENCE<br />
                <span className="text-[#D4AF37]">OUR WORK</span><br />
                IN 3D
              </h3>

              <p className="text-sm text-[#C9B29B] leading-relaxed max-w-md">
            ...
            <div className="flex-shrink-0 flex flex-col items-start lg:items-end gap-6">
              ...
              <div className="flex gap-8 text-center lg:text-right">
                <div>
                  <div className="text-3xl font-black text-[#D4AF37]">360°</div>
                  <div className="text-[9px] uppercase tracking-[0.3em] text-[#C9B29B] mt-1">Rotation</div>
                </div>
                <div className="w-[1px] bg-[#D4AF37]/20" />
                <div>
                  <div className="text-3xl font-black text-[#D4AF37]">6</div>
                  <div className="text-[9px] uppercase tracking-[0.3em] text-[#C9B29B] mt-1">Room Zones</div>
                </div>
                <div className="w-[1px] bg-[#D4AF37]/20" />
                <div>
                  <div className="text-3xl font-black text-[#D4AF37]">3</div>
                  <div className="text-[9px] uppercase tracking-[0.3em] text-[#C9B29B] mt-1">Light Modes</div>
                </div>
              </div>
              ...
              <button
                ...
                className="group inline-flex items-center gap-4 px-10 py-5 bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-[10px] uppercase tracking-[0.35em] font-black transition-all duration-300 shadow-[0_0_40px_rgba(201,168,76,0.15)] hover:shadow-[0_0_60px_rgba(201,168,76,0.3)]"
              >
                OPEN 3D HOUSE MODEL
      ...
      ═══════════════════════════════════════════ */}
      <section className="w-full bg-[#2B1C19] border-y border-[#D4AF37]/20 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#D4AF37]/25 to-transparent" />
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-[#D4AF37]/20">
            ...
            {[
              ...
              <div
                key={label}
                className="flex flex-col items-center justify-center py-12 px-6 text-center group hover:bg-[#3E2723] transition-colors duration-300"
              >
                <span className="text-5xl sm:text-6xl font-black text-[#D4AF37] leading-none tracking-tight group-hover:scale-105 transition-transform duration-300">
                  {number}
                </span>
                <span className="text-base sm:text-lg font-bold text-[#FAF7F0] mt-2 uppercase tracking-[0.15em]">
                  {label}
                </span>
                <span className="text-[9px] uppercase tracking-[0.3em] text-[#C9B29B] mt-1">
                  {sub}
                </span>
              </div>
            ))}
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#D4AF37]/25 to-transparent" />
      </section>

      {/* ═══════════════════════════════════════════
          7. PHOTO VAULT CALLOUT — EDITORIAL
      ═══════════════════════════════════════════ */}
      <section className="w-full bg-[#3E2723] border-b border-[#D4AF37]/15 relative overflow-hidden">
        {/* Decorative horizontal gold thread */}
        <div className="absolute top-1/2 left-0 right-0 h-[1px] -translate-y-1/2 bg-[#D4AF37]/5 pointer-events-none" />
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-24 sm:py-28">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-20 relative">
            ...
            <div
              ...
              style={{ color: '#D4AF37', opacity: 0.05 }}
              aria-hidden="true"
            >
              72
            </div>
            ...
            <div className="flex-shrink-0 relative">
              <div
                className="text-[100px] sm:text-[140px] font-black leading-none text-[#D4AF37] lg:hidden"
                style={{ opacity: 0.12 }}
                aria-hidden="true"
              >
                72
              ...
              <div className="lg:pl-8">
                <div className="flex items-center gap-4 mb-5">
                  <Images className="w-4 h-4 text-[#D4AF37]" strokeWidth={1.5} />
                  <span className="text-[10px] uppercase tracking-[0.4em] text-[#D4AF37] font-semibold">
                    MASTER PHOTO GALLERY
                  </span>
                </div>
                <div className="text-[80px] sm:text-[100px] font-black leading-none text-[#D4AF37] hidden lg:block mb-2">
                  72
                </div>
                <div className="text-[10px] uppercase tracking-[0.35em] text-[#C9B29B] hidden lg:block">
            ...
            <div className="flex-1 relative z-10">
              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#FAF7F0] leading-[1.05] tracking-tight mb-5">
                BROWSE ALL<br />
                <span className="text-[#D4AF37]">72 VERIFIED</span><br />
                CLIENT PHOTOS
              </h3>

              <p className="text-sm text-[#C9B29B] leading-relaxed max-w-lg mb-8">
              ...
              <div className="flex flex-wrap gap-2 mb-10">
                {['Kitchen', 'Paneling', 'Ceilings', 'Steel Doors', 'Aluminium', 'Wall Drop'].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 border border-[#D4AF37]/25 text-[#C9B29B] text-[9px] uppercase tracking-[0.25em] font-semibold"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <button
                ...
                className="group inline-flex items-center gap-4 px-10 py-5 bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-[10px] uppercase tracking-[0.35em] font-black transition-all duration-300"
              >
      ...
      ═══════════════════════════════════════════ */}
      <section className="w-full bg-[#2B1C19] relative overflow-hidden">
        {/* Top gold hairline */}
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          ...
          <div
            ...
            style={{ color: '#D4AF37', opacity: 0.025, letterSpacing: '-0.05em' }}
          >
            HYZIN
          </div>
          {/* Vertical gold thread left */}
          <div className="absolute top-0 bottom-0 left-[10%] w-[1px] bg-gradient-to-b from-[#D4AF37]/20 via-[#D4AF37]/5 to-transparent" />
          {/* Vertical gold thread right */}
          <div className="absolute top-0 bottom-0 right-[10%] w-[1px] bg-gradient-to-b from-[#D4AF37]/20 via-[#D4AF37]/5 to-transparent" />
        </div>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-32 sm:py-40 text-center">
          ...
          <div className="flex items-center justify-center gap-5 mb-10">
            ...
            <span className="text-[10px] uppercase tracking-[0.45em] text-[#D4AF37] font-semibold">
              COMMENCEMENT
            </span>
            <span className="w-16 h-[1px] bg-[#D4AF37]/40" />
          </div>
          ...
          {/* Massive headline */}
          <h2 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-[#FAF7F0] leading-[1.0] tracking-tight mb-4">
            HAVE A SPACE
          </h2>
          <h2 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black leading-[1.0] tracking-tight mb-4">
            <span className="text-[#D4AF37]">IN MIND?</span>
          </h2>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-[#FAF7F0] leading-[1.1] tracking-tight mb-12">
            LET'S SCULPT IT TOGETHER.
          </h2>

          {/* Subtext */}
          <p className="text-sm sm:text-base text-[#C9B29B] max-w-2xl mx-auto leading-relaxed mb-14">
          ...
          <div className="w-24 h-[1px] bg-[#D4AF37]/30 mx-auto mb-12" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <button
              ...
              className="group inline-flex items-center gap-4 px-10 py-5 bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-[10px] uppercase tracking-[0.4em] font-black transition-all duration-300 shadow-[0_0_50px_rgba(201,168,76,0.2)] hover:shadow-[0_0_80px_rgba(201,168,76,0.4)]"
            >
              START YOUR PROJECT
              <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
            </button>
            ...
            <a
              ...
              className="group inline-flex items-center gap-4 px-10 py-5 border border-[#D4AF37]/40 hover:border-[#D4AF37] text-[#FAF7F0] hover:text-[#D4AF37] text-[10px] uppercase tracking-[0.35em] font-black transition-all duration-300"
            >
          ...
          {/* Bottom tagline */}
          <p className="mt-16 text-[9px] uppercase tracking-[0.5em] text-[#3E2723] font-semibold">
