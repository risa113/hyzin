...
export default function HomePage({ onNavigate, onSelectProject, onOpenConsultation, onOpenLightbox }) {
  ...
  return (
    <div className="animate-page-enter">
      ...
      <section className="py-12 bg-[#3E2723] border-b border-[#C9B29B]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-10 rounded-3xl bg-[#2B1C19] text-[#FAF7F0] border border-[#C9B29B]/20 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/40 text-[#D4AF37] text-xs font-semibold tracking-wider uppercase mb-3">
                <Box className="w-3.5 h-3.5" /> 3D Interactive House Model
              </div>
              <h3 className="text-2xl sm:text-4xl text-[#FAF7F0] font-bold tracking-tight">
                Experience Our Work in <span className="text-[#D4AF37]">3D Interactive Space</span>
              </h3>
            ...
            <button
              ...
              className="relative z-10 px-8 py-4 rounded-2xl bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-xs uppercase tracking-[0.25em] font-bold transition-all shadow-xl flex items-center gap-2 whitespace-nowrap"
            >
      ...
      <section className="py-24 sm:py-32 bg-[#4E342E] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-6xl text-[#FAF7F0] font-bold leading-[1.12] tracking-tight">
                WE DESIGN SPACES <br />
                <span className="text-[#D4AF37] font-bold">WITH CHARACTER.</span>
              </h2>

              <p className="mt-6 text-base sm:text-lg text-[#C9B29B] font-normal leading-relaxed">
              ...
              <div className="mt-8 p-6 sm:p-8 bg-[#3E2723] border-l-2 border-[#D4AF37] shadow-lg shadow-black/20 relative animatic-reflection border border-[#C9B29B]/20">
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] font-medium block mb-2">
                  OUR PHILOSOPHY
                </span>
                <blockquote className="text-lg sm:text-xl text-[#FAF7F0] font-medium leading-relaxed">
              ...
              <div className="mt-8 flex items-center space-x-6">
                <button
                  ...
                  className="inline-flex items-center space-x-2 text-xs uppercase tracking-[0.25em] text-[#FAF7F0] hover:text-[#D4AF37] font-semibold transition-colors"
                >
            ...
            <div className="lg:col-span-5 relative">
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2B1C19]/80 via-transparent to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#2B1C19]/90 backdrop-blur-md border border-[#C9B29B]/20 shadow-md">
                  <span className="text-[9px] uppercase tracking-wider text-[#D4AF37] font-medium block">
                    ORIGINAL CLIENT WORK
                  </span>
                  <span className="text-base font-semibold text-[#FAF7F0] block">
      ...
      <section className="py-12 bg-[#3E2723]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-10 rounded-3xl bg-[#2B1C19] border border-[#C9B29B]/20 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-semibold tracking-wider uppercase mb-3">
                <Images className="w-3.5 h-3.5 text-[#D4AF37]" /> Master Photo Gallery (72 Photos)
              </div>
              <h3 className="text-2xl sm:text-3xl text-[#FAF7F0] font-bold tracking-tight">
                Browse All 72 Verified <span className="text-[#D4AF37]">Kerala Client Photos</span>
              </h3>
              <p className="mt-2 text-xs sm:text-sm text-[#C9B29B] font-normal leading-relaxed">
            ...
            <button
              ...
              className="px-8 py-4 rounded-2xl bg-[#D4AF37] text-[#2B1C19] text-xs uppercase tracking-[0.25em] font-bold hover:bg-[#FAF7F0] transition-all shadow-xl flex items-center gap-2 whitespace-nowrap"
            >
      ...
      <section className="py-20 bg-[#2B1C19] text-[#FAF7F0] text-center border-t border-[#C9B29B]/20">
        <div className="max-w-4xl mx-auto px-4">
          <span className="text-[10px] uppercase font-semibold tracking-[0.25em] text-[#D4AF37] block mb-3">
            COMMENCEMENT
          </span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#FAF7F0] font-bold tracking-tight mb-4">
            Have a space in mind? Let’s sculpt it together.
          </h2>
          <p className="text-sm sm:text-base text-[#C9B29B] font-normal max-w-xl mx-auto mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="px-8 py-4 bg-[#D4AF37] hover:bg-[#FAF7F0] text-[#2B1C19] text-xs uppercase tracking-[0.25em] font-bold transition-colors shadow-lg"
            >
              START YOUR PROJECT
            </button>
            <a
              ...
              className="px-8 py-4 border border-[#C9B29B]/30 hover:border-[#D4AF37] text-[#FAF7F0] hover:text-[#D4AF37] text-xs uppercase tracking-[0.2em] font-semibold transition-colors"
            >
