    ...
    <div className="animate-page-enter pt-12 pb-24 bg-[#FAF8F5]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 border-b border-black/[0.08]">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-6xl text-[#1E1D1B] font-extrabold leading-[1.12] tracking-tight">
            Reserve a Private <span className="text-[#9E8255]">Spatial Brief.</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-black/[0.08]">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-3 text-xs sm:text-sm text-[#736D66]">
            Official Email: <a href="mailto:Muhammedashad395@gmail.com" className="font-semibold text-[#1E1D1B] hover:text-[#9E8255] underline">Muhammedashad395@gmail.com</a>
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 bg-white border border-black/10 shadow-sm flex flex-col justify-between">
            <div>
              <span className="text-[10px] uppercase font-semibold tracking-wider text-[#9E8255] block mb-2">
                KERALA PRINCIPAL ATELIER & WORKSHOP
              </span>
              <h3 className="text-xl sm:text-2xl text-[#1E1D1B] font-bold tracking-tight mb-2">Kerala Design & Fabrication</h3>
              <p className="text-xs text-[#736D66] font-medium mb-4">Coordinates: 10°40'35.2"N 76°40'52.1"E</p>
              <p className="text-sm text-[#524D46] font-normal leading-relaxed mb-6">
            ...
            <div className="space-y-2 pt-4 border-t border-black/5">
              <a href="tel:916282549008" className="text-xs font-semibold text-[#9E8255] hover:underline flex items-center space-x-1">
                <span>+91 6282549008</span>
                <ArrowUpRight className="w-3 h-3" />
              </a>
              <a href="mailto:Muhammedashad395@gmail.com" className="text-xs font-medium text-[#736D66] hover:text-[#9E8255] flex items-center space-x-1">
                <Mail className="w-3 h-3 text-[#9E8255]" />
                <span>Muhammedashad395@gmail.com</span>
              </a>
              <a href="https://maps.app.goo.gl/FNC3ixVjpjQppRfm9" target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-[#1E1D1B] hover:text-[#9E8255] flex items-center space-x-1">
                <MapPin className="w-3 h-3 text-[#9E8255]" />
          ...
          <div className="p-8 bg-white border border-black/10 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl text-[#1E1D1B] font-bold tracking-tight mb-2">Bengaluru Private Cave</h3>
              <p className="text-xs text-[#736D66] font-medium mb-4">Lavelle Road / Indiranagar, Bengaluru</p>
              <p className="text-sm text-[#524D46] font-normal leading-relaxed mb-6">
                Tailored for high-rise sky galleries, penthouses, and bespoke technology executive headquarters.
              </p>
            </div>
            <div className="space-y-2 pt-4 border-t border-black/5">
              <a href="tel:918848023041" className="text-xs font-semibold text-[#9E8255] hover:underline flex items-center space-x-1">
          ...
          <div className="p-8 bg-white border border-black/10 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl text-[#1E1D1B] font-bold tracking-tight mb-2">Chennai Modernist Guild</h3>
              <p className="text-xs text-[#736D66] font-medium mb-4">Boat Club Road / Poes Garden, Chennai</p>
              <p className="text-sm text-[#524D46] font-normal leading-relaxed mb-6">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl text-[#1E1D1B] font-bold tracking-tight">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-6 text-left flex items-center justify-between text-lg sm:text-xl font-semibold text-[#1E1D1B] hover:text-[#9E8255] transition-colors"
                >
                  <span>{faq.q}</span>
                ...
                {isOpen && (
                  <div className="px-6 pb-6 text-sm sm:text-base text-[#524D46] font-normal leading-relaxed border-t border-black/5 pt-4 animate-fadeIn">
                    {faq.a}
                  </div>
                )}
              </div>
